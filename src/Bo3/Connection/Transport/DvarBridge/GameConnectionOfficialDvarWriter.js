...
const GameConnectionBridgeRuntime = require('./GameConnectionBridgeRuntime');
...
class GameConnectionOfficialDvarWriter {
     ...
     * @param {string} [options.patchDir] Directory containing or receiving bridge runtime files.
     ...
     */
    constructor(options = {}) {
        this.patchDir = GameConnectionBridgeRuntime.ensure(options.patchDir || process.env.BO3_T7PATCH_DIR);
